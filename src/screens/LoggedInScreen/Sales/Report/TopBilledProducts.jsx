    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.title}>Top 10 Billed Products</Text>
            ...
            <FlatList
                ...
                ListHeaderComponent={ // Adding a header for the table
                    <View style={styles.headerContainer}>
                        <Text style={styles.partnerHeader}>Product</Text>
                        <Text style={styles.revenueHeader}>Quantity</Text>
                    </View>
                }
                renderItem={({ item }) => (
                    <View style={styles.itemContainer}>
                        ...
                        <Text style={styles.revenue}>{item.quentity}</Text>
                    </View>
                )}
